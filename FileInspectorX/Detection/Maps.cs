...
public static class MimeMaps {
    ...
    public static readonly IReadOnlyDictionary<string, string> Default = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) {
        ...
        ["matroska"] = "application/x-matroska",
        ["webm"] = "application/webm",
        ["avif"] = "image/avif",
        ["mov"] = "video/quicktime",
        ["isobmff"] = "application/octet-stream",
        ...
        ["hive"] = "application/x-windows-registry-hive",
        ["evtx"] = "application/vnd.ms-windows.evtx",
        ["edb"] = "application/x-ese-database",
        ["kdbx"] = "application/x-keepass-kdbx",
...
public static class DangerousExtensions {
    ...
    public static readonly ISet<string> Default = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "reg", "hta", "lnk",
        "class", "dex", "wasm", "jar", "apk", "ipa", "crx", "deb", "rpm", "appx", "msix", "xap", "vsix"
    };
