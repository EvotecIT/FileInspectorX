...
when provider failure must terminate the file operation. Provider-free builds and unsupported
process architectures automatically remain deterministic-only.
