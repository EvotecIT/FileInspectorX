...
Use `-DisableMagika` (or `-UseMagika:$false`) for deterministic-only analysis, or
`-LearnedClassificationMode Required` when provider failure must terminate the file operation.
